...
MEM_0 := niosII_system_Onchip_Memory
...
MEM_1 := generic_tristate_controller_0
$(MEM_1)_NAME := generic_tristate_controller_0
...
$(MEM_1)_END := 0x01bfffff
$(MEM_1)_HIERARCHICAL_PATH := generic_tristate_controller_0
$(MEM_1)_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: generic_tristate_controller_0
generic_tristate_controller_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
