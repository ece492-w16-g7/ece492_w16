...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../niosII_gesture_detection.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x890c0
SOPC_SYSID_FLAG += --sidp=0x890c0
ELF_PATCH_FLAG  += --sidp 0x890c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1459975887
SOPC_SYSID_FLAG += --timestamp=1459975887
ELF_PATCH_FLAG  += --timestamp 1459975887
